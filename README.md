...
Once the `conda-forge` channel has been enabled, `ndf` can be installed with:

```
conda install ndf
```

It is possible to list all of the versions of `ndf` available on your platform with:
